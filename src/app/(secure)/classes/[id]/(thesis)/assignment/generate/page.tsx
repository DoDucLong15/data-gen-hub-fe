          ...
          <Card className="border border-gray-200 shadow-sm transition-shadow hover:shadow-md">
            <CardHeader className="border-b border-gray-100 bg-gray-50/50 pb-2">
              <CardTitle className="flex items-center gap-2 text-gray-800">
                ...
                {t('THESIS_PAGE.ASSIGNMENT.GENERATE.TEMPLATE_MANAGEMENT')}
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p className="text-xs">{t('THESIS_PAGE.ASSIGNMENT.GENERATE.TEMPLATE_MANAGEMENT_TOOLTIP')}</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </CardTitle>
          ...
          <Card className="border border-gray-200 shadow-sm transition-shadow hover:shadow-md">
            <CardHeader className="border-b border-gray-100 bg-gray-50/50 pb-2">
              <CardTitle className="flex items-center gap-2 text-gray-800">
                ...
                {t('THESIS_PAGE.ASSIGNMENT.GENERATE.GENERATE_FORM')}
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Info className="ml-1 h-3 w-3 cursor-help text-gray-400" />
                    ...
                    <TooltipContent>
                      <p className="text-xs">{t('THESIS_PAGE.ASSIGNMENT.GENERATE.GENERATE_FORM_TOOLTIP')}</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </CardTitle>
        ...
        <Card className="border border-gray-200 shadow-sm transition-shadow hover:shadow-md">
          <CardHeader className="border-b border-gray-100 bg-gray-50/50 pb-2">
            <CardTitle className="flex items-center gap-2 text-gray-800">
              ...
              {t('THESIS_PAGE.ASSIGNMENT.GENERATE.GENERATED_SHEETS')}
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Info className="ml-1 h-3 w-3 cursor-help text-gray-400" />
                  ...
                  <TooltipContent>
                    <p className="text-xs">{t('THESIS_PAGE.ASSIGNMENT.GENERATE.GENERATED_SHEETS_TOOLTIP')}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </CardTitle>
        ...
        <Card className="border border-gray-200 shadow-sm transition-shadow hover:shadow-md">
          <CardHeader className="border-b border-gray-100 bg-gray-50/50 pb-2">
            <CardTitle className="flex items-center gap-2 text-gray-800">
              ...
              {t('THESIS_PAGE.ASSIGNMENT.GENERATE.PROCESS_TABLE')}
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Info className="ml-1 h-3 w-3 cursor-help text-gray-400" />
                  ...
                  <TooltipContent>
                    <p className="text-xs">{t('THESIS_PAGE.ASSIGNMENT.GENERATE.PROCESS_TABLE_TOOLTIP')}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </CardTitle>
