  ...
  const InfoItem = ({
    ...
    <div className={cn('flex items-start space-x-3', className)}>
      ...
      <div className="space-y-1">
        ...
        <p className="font-medium">{value || <span className="text-muted-foreground italic">Không có dữ liệu</span>}</p>
      </div>
    </div>
  );
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="overflow-hidden p-0 sm:max-w-[600px]">
        <DialogHeader className="px-6 pt-6 pb-0">
          ...
          <DialogDescription>Chi tiết về người dùng này.</DialogDescription>
        </DialogHeader>
        ...
        {isLoading ? (
          ...
          <>
            <div className="px-6 py-4">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <InfoItem icon={<Phone size={18} />} label="Số điện thoại" value={user.phone} />
                <InfoItem icon={<Building size={18} />} label="Trường học" value={user.school} />
                <InfoItem icon={<BookOpen size={18} />} label="Khoa" value={user.department} />
                <InfoItem icon={<Users size={18} />} label="Chức vụ" value={user.position} />
                <InfoItem
          ...
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-lg font-medium text-red-500">Không thể tải thông tin người dùng</p>
