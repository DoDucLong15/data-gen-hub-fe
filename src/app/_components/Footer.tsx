      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            <h4 className="mb-4 text-lg font-semibold text-white">{t('FOOTER.CONTACT.TITLE')}</h4>
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-slate-700 pt-8 md:flex-row">
          <p className="text-base text-slate-400">
            {t('FOOTER.COPYRIGHT.RIGHTS').replace('{year}', currentYear.toString())}
          </p>
          <div className="mt-4 text-base text-slate-400 md:mt-0">
            <p>
              {t('FOOTER.COPYRIGHT.CREATED_BY')} <span className="font-medium text-indigo-400">ddlong07</span>
            </p>
          </div>
        </div>
      </div>
