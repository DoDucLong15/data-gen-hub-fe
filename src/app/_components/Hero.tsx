...
import { HERO } from '@/configs/messages.config';
  ...
  return (
    <div className="my-16 px-6 md:my-16">
      ...
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <h1 className="mt-4 mb-6 text-4xl font-bold text-slate-800 md:text-5xl lg:text-6xl">{HERO.TITLE}</h1>
        <p className="mb-8 max-w-3xl text-lg text-slate-600 md:text-xl">{HERO.DESCRIPTION}</p>
      ...
      <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
        <div className="rounded-xl bg-white p-6 shadow-sm transition-all hover:shadow-md">
          ...
          <h3 className="mb-3 text-xl font-bold text-slate-800">{HERO.FEATURES.DATA_COLLECTION.TITLE}</h3>
          <p className="text-slate-600">{HERO.FEATURES.DATA_COLLECTION.DESCRIPTION}</p>
        </div>
        ...
        <div className="rounded-xl bg-white p-6 shadow-sm transition-all hover:shadow-md">
          ...
          <h3 className="mb-3 text-xl font-bold text-slate-800">{HERO.FEATURES.SMART_DATA.TITLE}</h3>
          <p className="text-slate-600">{HERO.FEATURES.SMART_DATA.DESCRIPTION}</p>
        </div>
        ...
        <div className="rounded-xl bg-white p-6 shadow-sm transition-all hover:shadow-md">
          ...
          <h3 className="mb-3 text-xl font-bold text-slate-800">{HERO.FEATURES.COLLABORATION.TITLE}</h3>
          <p className="text-slate-600">{HERO.FEATURES.COLLABORATION.DESCRIPTION}</p>
        </div>
      </div>

      {/* Trust Badge - Enhanced */}
      <div className="mt-20 rounded-2xl bg-gradient-to-r from-slate-200 to-slate-400 py-10">
        <h3 className="mb-8 text-center text-2xl font-bold text-slate-900">{HERO.TRUSTED_BY}</h3>
